...
#         self.cv1 = nn.Conv2d(1, 16, kernel_size=5, stride=1, padding=1)
#         self.b1 = nn.BatchNorm2d(16)
#         self.mp1 = nn.MaxPool2d(2,2)
#         self.dp1 = nn.Dropout(p=0.1)
        
        self.cv2 = nn.Conv2d(1, 32, kernel_size=4, stride=1, padding=1)
        self.b2 = nn.BatchNorm2d(32)
        self.mp2 = nn.MaxPool2d(2,2)
        self.dp2 = nn.Dropout(p=0.1)
        
        self.cv3 = nn.Conv2d(32, 64, kernel_size=3, stride=1, padding=1)
        self.b3 = nn.BatchNorm2d(64)
        self.mp3 = nn.MaxPool2d(2,2)
        self.dp3 = nn.Dropout(p=0.2)
        
        self.cv4 = nn.Conv2d(64, 128, kernel_size=2, stride=1, padding=0)
        self.b4 = nn.BatchNorm2d(128)
        self.mp4 = nn.MaxPool2d(2,2)
        self.dp4 = nn.Dropout(p=0.3)
        
        self.cv5 = nn.Conv2d(128, 256, kernel_size=1, stride=1, padding=0)
        self.b5 = nn.BatchNorm2d(256)
        self.mp5 = nn.MaxPool2d(2,2)
        self.dp5 = nn.Dropout(p=0.4)
           
        self.fc1 = nn.Linear(43264, 1000)   #input 13 x 13 x 256 = 43264 
        self.b6 = nn.BatchNorm1d(1000)
        self.dp6 = nn.Dropout(p=0.5)
        
        self.fc2 = nn.Linear(1000, 1000)
        self.b7 = nn.BatchNorm1d(1000)
        self.dp7 = nn.Dropout(p=0.6)
